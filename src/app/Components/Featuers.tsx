  ...
  const features = [
    {
      ...
      description:"نظام فوترة آلي متطور لإدارة سلسة وفعالة لاشتراكاتك، موفرًا الوقت والجهد بتصميم بديهي.",
    },
    {
      id: 2,
      title: "حلول محاسبية مبسطة لتتبع المصروفات والأرباح",
      description:"نظام محاسبي مبسط يضمن التوازن المالي، مع تحليلات دقيقة لدعم قراراتك الاستراتيجية.",
    },
    {
      id: 3,
      title: "لوحة تحليل ديناميكية لرصد الإيرادات الشهرية",
      description:"لوحة تحليل متطورة تقدم رؤية شاملة لإيراداتك الشهرية وتحليلات أحمال الطاقة، مع واجهة تفاعلية.",
    },
    {
      id: 4,
      title: "برنامج متعدد الأجهزة بتجربة  فائقة السهولة",
      description:"برنامج شامل متعدد الأجهزة، يوفر تجربة استخدام آمنة ومرنة مع أعلى مستويات الأمان والخصوصية.",
    },
    {
      id: 5,
      title: "تطبيق جوال لإدارة قراءات العدادات بكفاءة",
      description:"تطبيق موبايل متطور لتسهيل عملية جمع البيانات وضمان الدقة والفعالية في إدارة الفواتير.",
    },
  ];
    ...
    <main className="w-full gap-6 flex flex-col items-center h-auto gap-y-10 py-10 ">
      ...
      <div className="flex flex-row justify-center items-center w-11/12 mt-8 ">
        {/* featuers */}
                ...
                {features.map((feature) => (
                    ...
                    {hoveredFeature === feature.id && (
                        <div className="mt-4 mr-12 text-gray-700 transition-opacity duration-300 opacity-100">
                        {feature.description}
                    </div>
                    )}
                    </div>
        ...
        {/* img */}
            ...
            <Image src="/dashbord.png" alt="dashbourd" width={550} height={500} className=" p-[20px] rounded-2xl bg-gradient-to-b to-[#4FBBED] from-[#0E648B]" />
            </div>
      </div>
    </main>
  );
